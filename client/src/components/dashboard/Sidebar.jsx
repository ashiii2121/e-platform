  ...
  return (
    <aside className={`dashboard__sidebar ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <nav className="sidebar__nav">
        <button
          className={`nav-item ${
            activeSection === "kerala-hse" ? "nav-item--active" : ""
          }`}
          onClick={() => setActiveSection("kerala-hse")}
        >
          <span className="nav-item__icon">🏛️</span>
          <span className="nav-item__text">Kerala HSE Papers</span>
        </button>
        <button
          className={`nav-item ${
            activeSection === "overview" ? "nav-item--active" : ""
          }`}
        ...
        <button
          className={`nav-item ${
            activeSection === "videos" ? "nav-item--active" : ""
          }`}
        ...
        <button
          className={`nav-item ${
            activeSection === "previous-papers" ? "nav-item--active" : ""
          }`}
        ...
        <button
          className={`nav-item ${
            activeSection === "model-tests" ? "nav-item--active" : ""
          }`}
        ...
        <button
          className={`nav-item ${
            activeSection === "progress" ? "nav-item--active" : ""
          }`}
