    ...
    <div className="auth-container gradient-bg">
      <div className="hero-signup">
        <div className="hero-text">
          <h1>Join the Platform, <span className="highlight">It's Free!</span></h1>
          <p>Unlock exclusive content, connect with a vibrant community, and start your journey today. No credit card required!</p>
        </div>
        <div className="hero-illustration">
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="60" cy="60" r="60" fill="#e0f7fa"/>
            <ellipse cx="60" cy="80" rx="35" ry="18" fill="#b2ebf2"/>
            <circle cx="60" cy="54" r="24" fill="#fff" stroke="#00796b" strokeWidth="2"/>
